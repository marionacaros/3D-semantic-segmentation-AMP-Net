...
from pointNet.model.pointnetRNN import BasePointNet, SegmentationWithAttention
...
def test(dataset_folder,
    ...
    base_pointnet = BasePointNet(point_dimension=test_dataset.POINT_DIMENSION,
                                 ...
                                 device=device)
    segmen_net = SegmentationWithAttention(GLOBAL_FEAT_SIZE, ATT_HEADS,num_classes=6)
    ...
    for data in progressbar(test_dataloader):
        ...
        logits, att_weights = segmen_net(gl_feats, lo_feats, np_cluster)  # [b, 2, 10240]
