...
from pointNet.model.pointnetAtt import GRUPointNet, RNNSegmentationPointNet
import logging
import warnings
...
def test(dataset_folder,
    ...
    # Initialize dataset
    test_dataset = LidarKmeansDataset(dataset_folder=dataset_folder,
